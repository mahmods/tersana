                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <div class="clearfix">
                                        <a class="btn green btn-outline" href="{{route('getBlogCategoryById',['categoryId'=>$category->blog_category_id])}}">
                                 ...
                                 <td>
                                <div class="clearfix">
                                    <form class="form-delete-c" method="post" onclick="return confirm('هل أنت  متأكد من  هذا الحذف')" action="{{route('deleteBlogCategoryById',['categoryId'=>$category->blog_category_id])}}">
                                        {{ csrf_field() }}
