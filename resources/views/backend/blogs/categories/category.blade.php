        ...
        <div class="col-md-12">
            <div class="portlet box yellow">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('updateBlogCategoryById',['categoryId'=>$category->blog_category_id])}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="{{trans('blog.description')}}" required>{{$category->name}}</textarea> 
                                    </div>
